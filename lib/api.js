 ...
 */
api.handleJwt = function(tokenUrl, clientId, clientSecret, scope, jwt, appName) {
  var deferred = q.defer();

  var form = {grant_type: 'jwt', client_id: clientId, client_secret: clientSecret, app_name: appName};
  if (scope !== undefined) {
    form.scope = scope;
  }
